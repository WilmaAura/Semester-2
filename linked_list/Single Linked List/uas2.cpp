...
using namespace std;
    ...
    public:
        ...
        Qnode* next;
        Qnode* prev;
        Qnode(string value): data(value), next(nullptr), prev(nullptr) {}      
    }; typedef Qnode qnode ;
    ...
    public:
        ...
        void enqueueAfter(string target, string value){
           if (isEmpty()){
        ...
        void enqueueBefore(string target, string value){
            qnode* current = head;
            if (isEmpty()){
                cout << "Tidak bisa menghapus, queue kosong" << endl;
                return;
        ...
        void dequeueBefore(string target){
            qnode* current = head;
            if (isEmpty()){
                cout << "TIDAK BISA MENGHAPUS, QUEUE KOSONG" << endl;
                return;
